...
const details = {
  "browser-use/browser-use": {
    ...
    audience: ["Agent 開發者", "工程師", "想研究瀏覽器自動化的人"],
    notFor: ["只想看教學、不想安裝 Python 的人", "完全不想碰瀏覽器自動化設定的人"],
    useCases: ["自動填表與瀏覽網站", "把重複性網頁操作交給 Agent", "研究 browser agent loop", "搭配 local model 測試網頁任務"],
  ...
  "OpenHands/OpenHands": {
    ...
    audience: ["工程師", "Agent 開發者", "想研究 AI 軟體工程的人"],
    notFor: ["沒有 Docker / 開發環境經驗的人", "只想要簡單聊天工具的人"],
    useCases: ["修 bug", "讀 repo 並修改程式", "跑測試與命令", "研究 coding agent 的沙箱與任務流程"],
  ...
  "cline/cline": {
    ...
    audience: ["工程師", "AI coding 使用者", "想在 IDE 裡跑 Agent 的人"],
    notFor: ["不寫程式的人", "不想讓工具讀寫專案檔案的人"],
    useCases: ["修改程式碼", "讀 repo", "產生測試", "解釋錯誤", "把小型工程任務交給 Agent"],
  ...
  "kortix-ai/suna": {
    ...
    audience: ["Agent 開發者", "PM", "想研究通用工作代理的人"],
    notFor: ["只想要單一 CLI 工具的人", "不想處理部署與帳號設定的人"],
    useCases: ["研究與資料整理", "多步驟任務執行", "公司內部 AI 工作台原型", "連接工具與瀏覽器任務"],
  ...
  "openinterpreter/openinterpreter": {
    ...
    audience: ["Local LLM 玩家", "工程師", "想讓模型操作電腦的人"],
    notFor: ["不想讓 Agent 執行本機命令的人", "沒有基本終端機概念的人"],
    useCases: ["執行程式碼", "本機檔案處理", "快速腳本", "local model coding agent 實驗"],
  ...
  "Significant-Gravitas/AutoGPT": {
    ...
    audience: ["Agent 開發者", "想研究自主代理歷史與平台化的人"],
    notFor: ["只想要簡單本機工具的人", "不想處理平台部署的人"],
    useCases: ["自主任務代理研究", "Agent workflow 實驗", "多步驟任務規劃", "開源 Agent 平台研究"],
  ...
  "crewAIInc/crewAI": {
    ...
    audience: ["工程師", "Agent 開發者", "想設計多代理流程的人"],
    notFor: ["只想要現成桌面 app 的人", "不想寫 Python 的人"],
    useCases: ["多角色任務分工", "研究 agent team", "自動化研究/寫作/分析流程", "把流程封裝成 crew"],
  ...
  "bytedance/UI-TARS-desktop": {
    ...
    audience: ["Agent 開發者", "GUI automation 研究者", "Local LLM 玩家"],
    notFor: ["只想要簡單文字 agent 的人", "沒有 multimodal / 桌面自動化概念的人"],
    useCases: ["桌面操作代理", "GUI automation", "browser/computer-use 研究", "本機 Operator 類實驗"],
  ...
  "simular-ai/Agent-S": {
    ...
    audience: ["Agent 研究者", "GUI automation 研究者", "工程師"],
    notFor: ["只想快速下載 app 的人", "沒有 Python / agent framework 經驗的人"],
    useCases: ["桌面任務代理", "GUI 操作研究", "computer-use benchmark", "自動化真實軟體操作"],
  ...
  "langgenius/dify": {
    ...
    audience: ["PM", "工程師", "內部 AI 平台建置者"],
    notFor: ["只想要單一 CLI agent 的人", "完全不想部署服務的人"],
    useCases: ["建立 AI app", "設計 agentic workflow", "內部知識助理", "自架 AI 工作流平台"],
